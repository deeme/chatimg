    ...
    <div className="border-l border-l-[#edeeee] h-full flex flex-col">
      ...
      >
        ...
        <Panel header={i18n.chat_mode_image} key="3">
          ...
          {configs.imageModel === 'dalle-3' ||
          configs.imageModel === 'dall-e-3' ||
          configs.imageModel === 'sdxl' ||
          configs.imageModel === 'stable-diffusion-v1.5' ||
          configs.imageModel === 'stable-diffusion-v2.1' ||
          configs.imageModel === 'kandinsky-v2.2' ||
          configs.imageModel === 'kandinsky-v2' ||
          configs.imageModel === 'deepfloyd-if' ||
          configs.imageModel === 'openjourney-xl' ||
          configs.imageModel === 'openjourney-v4' ||
          configs.imageModel === 'dreamshaper' ||
          configs.imageModel === 'majicmixsombre' ||
